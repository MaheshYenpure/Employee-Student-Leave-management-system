...
function StudentDashboard({ setAllLeaves }) {
  ...
  const handleApplyLeave = (e) => {
    e.preventDefault();
    const newLeave = { leaveType, startDate, endDate, reason, status: "Pending", role: "Student" };
  ...
  return (
    <div className="login-box">
      <h2 className="login-title">Student Dashboard</h2>
